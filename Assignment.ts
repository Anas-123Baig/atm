...
// Hello Admin
let usernames: string[] = ["admin", "Eric", "Alice", "Bob", "Charlie"]; // Array of usernames
...
let new_users: string[] = ["admin", "David", "Eve", "Frank", "George"];
...
function make_car(manufacturer: string, model: string, ...args: string[]): Car {
